namespace SeriesTracker.Core.Models
{
    ...
    public class UserSeries
    {
        ...
        /// </summary>
        /// <param name="id">Уникальный идентификатор записи о просмотре аниме пользователем.</param>
        /// <param name="animeId">Идентификатор аниме.</param>
        /// <param name="userId">Идентификатор пользователя.</param>
        /// <param name="categoryId">Идентификатор категории, к которой пользователь отнес данныйаниме.</param>
        ...
        /// <summary>
        /// Уникальный идентификатор записи о просмотре аниме пользователем.
        /// </summary>
        public Guid Id
        {
            get;
        ...
        /// <summary>
        /// Идентификатор категории, к которой пользователь отнес данныйаниме.
        /// </summary>
