...
namespace SeriesTracker.Tests.UserSeriesRepositoryTests
{
    ...
    public class GetUserSeriesTests : IClassFixture<UserSeriesRepositoryTestsBase>, IDisposable
    {
        ...
        // Тест, проверяющий, что метод GetSeriesAnimeId возвращает корректный словарь, содержащий данные о аниме, связанных с пользователем, для заданного списка идентификаторов аниме. Тест параметризован и использует разные наборы данных для проверки различных сценариев, включая наличие и отсутствие данных.
        [Theory]
